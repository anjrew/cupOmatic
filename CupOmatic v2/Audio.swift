...
//    var roundThree =
    ...
    func playGetReady(){
        ...
        print("Try Audio")
        guard let url = Bundle.main.url(forResource: "Get ready final", withExtension: "wav") else { return }
